...
public class TipoController {
    ...
    @Operation(summary = "Criar um novo tipo que pode ser usado para Pokémons ou Ataques")
    ...
    @Operation(summary = "Buscar todos os tipos pelo id sem ordem")
    ...
    public ResponseEntity<TipoResponseDTO> alterarTipo(@RequestBody TipoRequestDTO tipoRequestDTO,
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(new TipoResponseDTO(tipoParaAlterar.getId(), tipoParaAlterar.getNome()));
    }
}