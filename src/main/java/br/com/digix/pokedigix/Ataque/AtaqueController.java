...
public class AtaqueController {
    ...
    @ApiResponse(responseCode = "200", description = "Retorna um ataque solicitado")
    ...
    public ResponseEntity<AtaqueResponseDTO> buscarPorId(@PathVariable Long id) {
                ...
                return ResponseEntity.ok(new AtaqueResponseDTO(ataque.getId(),
                 ataque.getNome(), ataque.getForca(),
                 ataque.getAcuracia(), ataque.getPontosDePoder(), ataque.getCategoria(), 
                 ataque.getDescricao(), tipoResponseDTO));
